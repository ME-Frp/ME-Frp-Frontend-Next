        ...
        <div class="content">
            ...
            <div class="right">
                <svg width="414" height="212" viewBox="0 0 414 212" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M205.516 80.2674H139.419L148.186 141.237H197.788L205.516 80.2674Z" stroke="#6ECCE5"
                        stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                    <path d="M205.516 80.2674H139.419L148.186 141.237H197.788L205.516 80.2674Z" stroke="#6ECCE5"
                        stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                    <rect x="137" y="75" width="70.9351" height="9.39611" rx="2.40792" fill="#C5EBF5" stroke="#6ECCE5"
                        stroke-width="2"></rect>
                    <path
                    ...
                    <path d="M85.6775 57.6815H163.733V127.819H85.6775V57.6815Z" fill="#C5EBF5" stroke="#0055DC"
                        stroke-width="2">
                    </path>
                    <path
                    ...
                    <path
                        ...
                        fill="#C5EBF5" stroke="#0055DC" stroke-width="2"></path>
                    <path d="M153.931 60.0436H159.587V126.787H153.931V60.0436Z" fill="white"></path>
                    <path d="M159.528 55.6816H153.703L149.151 32.3329C149.151 32.3329 158.005 44.3703 159.528 55.6816Z"
                        fill="white"></path>
                    <path
                        ...
                        fill="white" stroke="#0055DC" stroke-width="2" stroke-miterlimit="10"></path>
                    <path
                    ...
                    <path
                        ...
                        stroke="#0055DC" stroke-width="2"></path>
                    <path
                    ...
                    <path d="M235.863 57.1286H313.919V127.266H235.863V57.1286Z" fill="#C5EBF5" stroke="#0055DC"
                        stroke-width="2">
                    </path>
                    <path
                    ...
                    <path d="M309.713 55.1288H303.889L299.336 31.7801C299.336 31.7801 308.19 43.8175 309.713 55.1288Z"
                        fill="white">
                    </path>
                    <path
...
export default {
    ...
    metaInfo: {
        title: '页面未找到 | 幻缘映射',
        link: [
            { rel: 'icon', href: 'https://resources.mefrp.com/d/ME-Frp/Local/Others/logo.svg' }
        ]
    },
    setup() {
...
@use '../assets/styles/notFound.scss' as *;
</style>
